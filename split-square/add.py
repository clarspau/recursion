...
def add(s1, s2):
    """Produces a new square by adding two input squares."""

    # Base case: both are simple filled squares
    if type(s1) == type(s2) == int:
        # Return the logical OR of squares: if either is filled in, it's filled in;
        # otherwise, it's empty
        return s1 | s2

    # Otherwise, if one is a filled square and not a divided square,
    ...
    # Recursively find the sum of four quadrants of both squares
    # zip(s1, s2) pairs corresponding elements, creating pairs [(1, 0), (1, 0), (1, 0), (1, 0)]
